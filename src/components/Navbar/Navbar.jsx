      ...
      <div className="navbar max-w-7xl mx-auto">
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className="menu menu-md dropdown-content bg-base-100 rounded-box z-50 mt-3 w-52 p-2 shadow text-text"
            >
              {navItems}
            </ul>
          </div>
        ...
        <div className="navbar-end">
          <label className="swap swap-rotate cursor-pointer">
            ...
            <input
              ...
              checked={theme === "dark"} // controlled by context now
            />
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <div
                className="avatar tooltip w-10 tooltip-left"
